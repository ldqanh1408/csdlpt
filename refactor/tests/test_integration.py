...
from refactor.strict import StrictWatermarkEngine, StrictCoordinator, StrictWorker
from refactor.heuristic import HeuristicWatermarkEngine, HeuristicAggregator, DLQPipeline
...
class TestKafkaIntegration:
    ...
    def test_kafka_full_pipeline(self):
        ...
        from refactor.strict.worker import StrictWorker
