...
class StrictWatermarkEngine:
    ...
    def summary(self) -> dict:
        ...
        result = {
            ...
            "network_ingest_latency_p50_us": _lat_us(self.metrics.T_network_ingest_ns, 0.50),
            "network_ingest_latency_p95_us": _lat_us(self.metrics.T_network_ingest_ns, 0.95),
            "network_ingest_latency_p99_us": _lat_us(self.metrics.T_network_ingest_ns, 0.99),
